package com.example.simpletageview.tagview1;
...
import com.example.simpletageview.tagview1.view.TagContainerLayout;
import com.example.simpletageview.tagview1.view.TagView;
...
public class NiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_nice);
        ...
        mTagContainerLayout1.setOnTagClickListener(new TagView.OnTagClickListener() {
            ...
            public void onTagClick(int position, String text) {
                Toast.makeText(NiceActivity.this, "click-position:" + position + ", text:" + text,
                        Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onTagLongClick(final int position, String text) {
                AlertDialog dialog = new AlertDialog.Builder(NiceActivity.this)
                        .setTitle("long click")
...
//                mTagContainerLayout1.addTag(text.getText().toString(), 4);
        ...
        mTagContainerLayout1.postDelayed(new Runnable() {
            @Override
            public void run() {
